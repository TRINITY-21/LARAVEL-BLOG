...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('app/css/styles.css')}}">
       <link href="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.css') }}" rel="stylesheet"/>  
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            ...
                            <div class="overlay"></div>
                            <a href="{{$second_post -> featured }}" alt="{{$second_post -> title}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{ route('category.single', ['id' => $first_post->category->id]) }}">{{$second_post->category->name }}</a>
                                        </span>
        ...
        <div class="row medium-padding120 bg-border-color">
            <div class="container">
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            ...
                            @foreach($career->posts()->orderby('created_at','desc')->take(2)->get() as $post)
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                              @foreach($tutorials->posts()->orderby('created_at','desc')->take(2)->get() as $post)
